...
const ERPClientMemberModal = ({form, setForm}) => {
    ...
    const onMemberSelected = (mem) => {
        const data = {...form, client_employee : mem.member_info_id}
        setForm(data);
        handleClose();
    }
  ...
  return (
    <>
        <Form.Control value={form.client_employee} name='client_employee' placeholder='거래처담당자' onClick={handleShow} readOnly/>
...
export default ERPClientMemberModal